...
class EpochVisitedSetTest {
    ...
    @Test
    @DisplayName("EpochVisitedSet: Dynamic capacity expansion preserves state and accommodates large IDs")
    ...
    void testNegativeIndices() {
        ...
        assertThatThrownBy(() -> set.isVisited(-1))
                .isInstanceOf(IndexOutOfBoundsException.class);

        assertThatThrownBy(() -> set.markVisited(-1))
                .isInstanceOf(IndexOutOfBoundsException.class);
    }
}
