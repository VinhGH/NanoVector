...
class NeighborSelectorTest {
    ...
    @Test
    @DisplayName("NeighborSelector: Algorithm 4 prefers angular diversity over collinear occluded nodes")
    void testAlgorithm4HeuristicPrefersAngularDiversity() {
        ...
        NeighborSelector.NodeDistanceEvaluator evaluator = (a, b) -> {
        ...
        // Request maxDegree = 2
        // Algorithm 4 should select A (dist 1.0), then C (dist 1.2), rejecting B because B is closer to A (dist 1.0 <= 2.0)
    ...
    @Test
    @DisplayName("NeighborSelector: Fallback fills remaining capacity when heuristic prunes too aggressively")
    ...
    @Test
    @DisplayName("NeighborSelector: Deterministic tie-breaking on identical distance orders by ID ascending")
