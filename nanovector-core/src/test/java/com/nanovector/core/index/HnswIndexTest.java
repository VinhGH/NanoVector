...
class HnswIndexTest {
    ...
    void testCosineMetric() {
        ...
        assertThat(results).hasSize(2);
        assertThat(results.get(0).id()).isEqualTo(1L);
        assertThat(results.get(0).distance()).isCloseTo(0.0f, org.assertj.core.data.Offset.offset(1e-5f));
    }
    ...
    @Test
    @DisplayName("searchKnn with custom efSearch returns valid results and enforces positive efSearch")
