...
/**
 * Empirical Recall@10 verification of {@link HnswIndex} against the {@link FlatIndex}
 * Ground Truth Oracle.
 * <p>
 * Evaluates recall on a 1,000-vector dataset of 128-dimensional vectors with 50 test queries.
...
class HnswRecallTest {
    ...
    void testRecallAtKAgainstFlatIndex() {
        ...
        System.out.println("=== HNSW Recall@10 vs FlatIndex Oracle (N=1000, D=128, Q=50, M=16, efConstruction=200) ===");
        ...
        for (int e = 0; e < efSearchValues.length; e++) {
            ...
            recalls[e] = recall;
            System.out.printf("  efSearch = %3d -> Recall@10 = %.4f (%.2f%%)%n",
                    ef, recall, recall * 100.0);
        }
