 ...
 * <p>
 * Ensures that all nodes have level &ge; 0 (exist on layer 0), while higher layers
 * have exponentially fewer nodes to form the hierarchical skip-list routing graph.
 */
