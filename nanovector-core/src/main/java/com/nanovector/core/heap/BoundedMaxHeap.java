 ...
 *
 * <p>Under the distance minimization contract, the "worst" candidate in the Top-K (largest
 * distance, or largest ID upon distance tie) resides at the root (index 0).
 *
 * <p>Internal representations use primitive arrays ({@code long[]}, {@code float[]}) to completely
 * eliminate allocations during candidate evaluations.
 */
public final class BoundedMaxHeap {
   ...
   *
   * <p>"Worse" means: 1. Larger distance. 2. If distances are identical, larger ID.
   */
