 ...
 * <p>
 * Serves as the <b>Ground Truth Oracle</b> for measuring recall and verifying
 * approximate nearest neighbor (ANN) indexes.
 * <p>
 * Key performance characteristic:
 * Evaluates distances directly against the contiguous primitive buffer of {@link VectorStorage},
 * producing zero allocations inside the $N$-element distance scan loop.
 */
