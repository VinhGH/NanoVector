...
/**
 * SIMD-accelerated squared Euclidean distance ($L_2^2$) using the Java Vector API ({@code
 ...
 * </pre>
 *
 * <p>Leverages {@link FloatVector#SPECIES_PREFERRED} to compute vector differences and fused
 * multiply-adds in data-parallel SIMD lanes, with a scalar tail loop for remaining elements.
 */
