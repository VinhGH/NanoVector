...
/**
 * SIMD-accelerated inverted Dot Product distance using the Java Vector API ({@code
 ...
 * </pre>
 *
 * <p>Negates the dot product to conform to the <b>Distance Minimization</b> contract. Computes
 * parallel inner products across SIMD lanes using {@link FloatVector#SPECIES_PREFERRED}.
 */
