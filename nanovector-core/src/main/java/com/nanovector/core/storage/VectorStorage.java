 ...
 * <p>
 * Maintains vectors in a single continuous 1D {@code float[]} array:
 * <pre>
...
public final class VectorStorage {
     ...
     * @throws IllegalArgumentException if vector length mismatch, contains NaN/Inf, or externalId already exists
     */
    ...
    /**
     * Copies the vector at the specified internal index into a provided destination array,
     ...
     * <p>
     * Used by {@link com.nanovector.core.distance.DistanceCalculator} to calculate distances
